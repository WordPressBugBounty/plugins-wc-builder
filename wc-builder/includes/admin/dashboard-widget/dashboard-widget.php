...
<?php
$info_data = WPBFORWPBAKERY_Api::get_remote_data();
        ...
        <ul>
            <li>
                <a href="https://hasthemes.com/blog/" target="_blank">
                    <?php esc_html_e( 'Blog', 'wpbforwpbakery' ); ?>
                    <span aria-hidden="true" class="dashicons dashicons-external"></span>
                </a>
            </li>
            <li>
                <a href="https://hasthemes.com/docs/" target="_blank">
                    <?php esc_html_e( 'Documentation', 'wpbforwpbakery' ); ?>
                    <span aria-hidden="true" class="dashicons dashicons-external"></span>
                </a>
            </li>
            <li>
                <a href="https://hasthemes.com/contact-us/" target="_blank">
                    <?php esc_html_e( 'Support', 'wpbforwpbakery' ); ?>
                    <span aria-hidden="true" class="dashicons dashicons-external"></span>
                </a>
            </li>
        </ul>
